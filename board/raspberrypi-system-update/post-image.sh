...
# Use the VFAT image to build boot.img. This is the file downloaded by rpi-system-update
rm -rf "${GENIMAGE_TMP}"
rm -f "${BINARIES_DIR}/boot.img" "${BINARIES_DIR}/boot.img.gz" "${BINARIES_DIR}/boot.img" "${BINARIES_DIR}/boot.sig"
genimage \
...
#
# sdcard.img is used to install systems without net-install
rm -rf "${GENIMAGE_TMP}"
...
# rpi-system-update expects the file to be compressed
gzip "${BINARIES_DIR}/boot.img"
